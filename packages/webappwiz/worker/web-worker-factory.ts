	...
	implements RunnerFactory<Input, Output>
{
	...
	// scry-ignore objects-over-callbacks: `construct` is a Runner constructor, which is exactly what a bundler's `?worker` import hands you; an interface around it would be a file that says `new`
	constructor(
