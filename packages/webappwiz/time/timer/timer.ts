 ...
 */
// scry-ignore objects-over-callbacks: the signature the platform's own setTimeout and setInterval have, so events would mean every caller subscribing to a one-shot they already wrote as a closure
