 ...
 */
// lint-ignore objects-over-callbacks: a component reacts to a transition with a closure over its own props, and handing it a Dispatcher instead would need another hook to subscribe and unsubscribe
