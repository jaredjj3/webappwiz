...
>(
	source: Source,
	// rule-ignore objects-over-callbacks: a projection run to compute what the hook returns, which the guide calls fine; the ref only keeps a fresh inline arrow from re-subscribing
