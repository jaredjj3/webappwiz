 ...
 */
// scry-ignore objects-over-callbacks: `useEffect` with a disposer threaded through, so the effect function is React's contract rather than one this package invented
